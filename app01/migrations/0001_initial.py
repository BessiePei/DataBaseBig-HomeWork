# Generated by Django 4.0.6 on 2022-12-23 08:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blogContent', models.CharField(default='NO CONTENT!', max_length=3000, verbose_name='帖子内容')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isMerchant', models.BooleanField(choices=[(True, '是'), (False, '否')], default=False, verbose_name='是否是商家')),
        ...
        migrations.AddField(
            model_name='blog',
            name='blogLabel',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='labeled_blog', to='app01.bloglabel', verbose_name='标签'),
        ),
        migrations.AddField(
            model_name='blog',
            name='blogsActivitys',
